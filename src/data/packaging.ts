...
export const packagingItems: PackagingItem[] = [
  ...
  },
  {
    ...
    image: imageUrls.jarPackLabeled,
  ...
  },
  {
    ...
    image: imageUrls.ironBasketPack,
    range: 'Lamp specific',
