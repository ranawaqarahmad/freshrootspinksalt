    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-5xl text-stone-900 mb-4">Sourcing & Quality Control</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {processes.map((process, index) => {
            ...
            return (
              <div
                key={index}
                className="relative bg-stone-50 p-8 rounded-2xl border border-stone-200 hover:shadow-lg transition-all duration-300"
              >
                ...
                <div className="pt-6">
                  ...
                  <h3 className="text-xl text-stone-900 mb-3">{process.title}</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative rounded-2xl overflow-hidden shadow-xl">
            <ImageWithFallback
              src="https://images.unsplash.com/photo-1599583863916-e06c29087f51?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxxdWFsaXR5JTIwY29udHJvbCUyMGluc3BlY3Rpb258ZW58MXx8fHwxNzY3NzgzMDE5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
              alt="Quality Control"
          ...
          <div>
            <h3 className="text-3xl text-stone-900 mb-6">Why Our Process Matters</h3>
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-[#E88B7F] rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <h4 className="text-lg text-stone-900 mb-2">Consistency</h4>
              ...
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-[#E88B7F] rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <h4 className="text-lg text-stone-900 mb-2">Transparency</h4>
                  <p className="text-stone-600">
              ...
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-[#E88B7F] rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <h4 className="text-lg text-stone-900 mb-2">Risk Mitigation</h4>
                  <p className="text-stone-600">
              ...
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-[#E88B7F] rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <h4 className="text-lg text-stone-900 mb-2">Buyer Confidence</h4>
                  <p className="text-stone-600">
